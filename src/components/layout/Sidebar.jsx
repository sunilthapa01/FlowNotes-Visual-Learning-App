...
import {
  Zap, Plus, FileText, Hash, Star, Trash2,
  ChevronRight, X, GripVertical
} from 'lucide-react'

// const SAMPLE_NOTES = [
//   { id: 1, title: 'Project Alpha Flow', tags: ['design', 'ui'], starred: true, nodes: 8 },
//   { id: 2, title: 'Backend Architecture', tags: ['dev', 'api'], starred: false, nodes: 12 },
//   { id: 3, title: 'User Journey Map', tags: ['ux', 'research'], starred: true, nodes: 5 },
//   { id: 4, title: 'Q2 Roadmap Planning', tags: ['strategy'], starred: false, nodes: 7 },
//   { id: 5, title: 'Onboarding Flow v2', tags: ['product'], starred: false, nodes: 9 },
// ]
...
export default function Sidebar({ activeNote, onSelectNote, onCreateNote, isOpen, onClose,notes }) {
    ...
    <>
      ...
      <div
        ...
        className={`
          ...
          w-64 xl:w-72
          glass border-r border-[var(--border-subtle)]
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border-subtle)]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-xs text-[var(--text-muted)]">Visual Learning</span>
            </div>
          </div>
          <button
            onClick={onClose}
            className="lg:hidden w-6 h-6 flex items-center justify-center rounded-md text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors"
          >
            <X size={14} />
          </button>
        </div>
